...
public class AddTestimonioActivity extends ActionBarActivity implements OnClickListener {
	private static final String TAG_CLASS = AddTestimonioActivity.class.getName();
	...
	public void initUI() {
		etName = (EditText) findViewById(R.id.addtestimonio_et_name); // Name
		etEmail = (EditText) findViewById(R.id.addtestimonio_et_email); // Email

		spCategory = (Spinner) findViewById(R.id.addtestimonio_sp_category); // Category
		...
		rgGender = (RadioGroup) findViewById(R.id.addtestimonio_rg_gender); // Gender
		rbGenderMale = (RadioButton) findViewById(R.id.addtestimonio_rb_gender_male); // Gender Male
		rbGenderFemale = (RadioButton) findViewById(R.id.addtestimonio_rb_gender_female); // Gender Female

		spScholarity = (Spinner) findViewById(R.id.addtestimonio_sp_scholarity); // Scholarity
		loadDataFromResources(spScholarity); // Load data to spinner from resources
		
		btnSendData = (Button) findViewById(R.id.addtestimonio_btn_senddata);
	...
	public void loadDataFromResources(Spinner spinner) {
		...
		switch (spinner.getId()) {
			case R.id.addtestimonio_sp_category:
				listData = getResources().getStringArray(R.array.addtestimonio_categories);
				loadDataArrayAdapter(spinner, listData);
				break;
	
			case R.id.addtestimonio_sp_city:
				listData = getResources().getStringArray(R.array.addtestimonio_cities);
				loadDataArrayAdapter(spinner, listData);
				break;
	
			case R.id.addtestimonio_sp_age:
				listData = getResources().getStringArray(R.array.addtestimonio_ages);
				loadDataArrayAdapter(spinner, listData);
				break;
	
			case R.id.addtestimonio_sp_scholarity:
				listData = getResources().getStringArray(R.array.addtestimonio_scholarities);
				loadDataArrayAdapter(spinner, listData);
				break;
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.addtestimonio_btn_senddata:
			sendData();
			break;
	...
	private class SendDataAsyncTask extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			dialog = new ProgressDialog(AddTestimonioActivity.this);
			dialog.setMessage(getResources().getString(R.string.addtestimonio_senddata_loading));
